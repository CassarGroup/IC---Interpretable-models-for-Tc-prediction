...
from script_gam_linear_terms import Clustering_GAM, train_validation
...
def create_instance(trial):
    ...
    if clusterer_type == "kmeans":
        n_clusters = trial.suggest_int("n_clusters", 1, 15)
        clusterer = KMeans(
        ...
        n_clusters = trial.suggest_int("n_clusters_bkmeans", 1, 15)
        ...
        n_clusters = trial.suggest_int("n_clusters_birch", 1, 15)
